...
<body>
    ...
    <section class="home">
        ...
        <main class="discussion-title-content">
            ...
            <div class="upvote">
                <img class="upvote-logo" src="../images/like.png" alt="like-logo">
                {{count(App\Models\Vote::where('discussion_id', $d->id)->where('is_upvote', 1)->get())}} Likes
            </div>
            <div class="downvote">
                <img class="downvote-logo" src="../images/dislike.png" alt="dislike-logo">
                {{count(App\Models\Vote::where('discussion_id', $d->id)->where('is_upvote', 0)->get())}} Dislikes
            </div>
            <div class="favorite">
                <img class="favorite-logo" src="../images/bookmark.png" alt="favorite-logo">
                {{count(App\Models\Favorite::where('discussion_id', $d->id)->get())}} Bookmarks
            </div>
        </main>
        @endforeach
        </div>
